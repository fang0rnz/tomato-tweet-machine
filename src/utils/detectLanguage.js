  ...
  return {
    ...
    info: function (text, callback) {
      ...
      this.detect(text, function (language) {
        ...
        if (language === "af") {
          callback.apply(undefined, [["nl", IANA_MAP["nl"], NAME_MAP["nl"]]]);
          return;
        }
...
const languageGuesser = guessLanguage();

export { languageGuesser };
